...
//https://learn.sparkfun.com/tutorials/interactive-led-music-visualizer?_ga=2.201642198.69736393.1530543117-964836628.1495141751
//Libraries
...
void loop() {  //This is where the magic happens. This loop produces each frame of the visual.
  volume = analogRead(AUDIO_PIN) * 1.2;       //Record the volume level from the sound detector
